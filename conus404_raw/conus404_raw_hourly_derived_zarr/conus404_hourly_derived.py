...
from ..conus404_helpers import delete_dir, set_target_path
from ..conus404_maths import rh_teten, specific_humidity, vp, saturation_vp_teten
...
def main():
    ...
    for ii in range(index_start, index_end):
        ...
        ds2['ES2'] = saturation_vp_teten(ds2.T2)

...
def main():
    ...
    # ds[['time']] saves the 'time' DataSet which includes the global attributes
    # ds['time'] saves the 'time' DataArray which has no global attributes so the
    #            existing global attributes get removed.

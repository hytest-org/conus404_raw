...
def main():
    ...
    parser.add_argument('-e', '--enddate', help='End date in format YYYY-MM-DD', required=True)
    ...
    with Client(cluster) as client:
        ...
        ds = xr.open_dataset(args.src_zarr, engine='zarr', backend_kwargs=dict(consolidated=True), chunks={})
        ...
        dates = pd.date_range(start=ds.time[0].values, end=args.enddate, freq='1h')
